...
- (void)viewDidLoad {
    ...
    /*
    UIStoryboard* frontStoryboard = [UIStoryboard storyboardWithName:@"PhotoBooth" bundle:nil];
    UIViewController *frontController = [frontStoryboard instantiateViewControllerWithIdentifier:self.controllerId];*/
