...
/*
    ...
    */
    ControllerInfo* sidebar1 = [[ControllerInfo alloc] initWithName:@"Camera" andControllerId:@"SCViewController"];
    ControllerInfo* sidebar2 = [[ControllerInfo alloc] initWithName:@"Photo Booth" andControllerId:@"SidebarController2"];
    
    StoryboardInfo* sidebarStoryboard = [[StoryboardInfo alloc] initWithName:@"Selfie Booth" andStoryboardId:@"SidebarStoryboard"];
    ...
    self.storyboards = @[sidebarStoryboard];
...
-(UIViewController*)getControllerFromStoryboardInfo:(StoryboardInfo*)storyboardInfo andControllerInfo:(ControllerInfo*)controllerInfo {
    ...
    if([storyboardInfo.name rangeOfString:@"Selfie Booth"].location == NSNotFound){
